...
const PROFILES = [
  { id: 'u-admin', email: 'andrecouto10@gmail.com', name: 'André Couto', role: 'admin', company: 'procarro', created_at: '2026-07-01' },
  { id: 'u-2', email: 'didier@procarro.pt', name: 'Didier', role: 'member', company: 'fercopor', created_at: '2026-07-01' },
]
const TICKETS = [
  { id: 't1', game_id: 'g1', category: 'bancada', zone: 'ARQ. POENTE', sector: '41', row: '8', seat: '1', gate: '5-6-24-25', entrance: '36', floor: null, code: '864347', file_path: 'g1/t1.pdf', assigned_to: 'u-2', guest_note: null, assignee: { id: 'u-2', name: 'Didier', company: 'fercopor' }, shares: [] },
  ...
  { id: 't3', game_id: 'g1', category: 'camarote', zone: 'Cam 5', sector: null, row: '10', seat: '3', gate: '1', entrance: null, floor: null, code: '231014', file_path: 'g1/t3.pdf', assigned_to: 'u-admin', guest_note: null, assignee: { id: 'u-admin', name: 'André Couto', company: 'procarro' }, shares: [{ id: 's1', guest_name: 'João Silva', guest_contact: '912345678', url: 'https://x/pdf', revoked: false, created_at: '2026-07-20', shared_by: 'u-admin' }] },
...
const GAME = { id: 'g1', title: 'FC Porto x OGC Nice', opponent: 'OGC Nice', competition: 'Liga Europa', match_date: '2025-11-27', match_time: '17:45', created_at: '2026-07-01', kids: [{ id: 'k1', game_id: 'g1', name: 'Tomás', birthdate: '2018-05-12', sent_at: null, sent_by: null, added_by: 'u-admin', adder: { name: 'André Couto' } }], tickets: TICKETS }
const ACTIVITY = [
...
await p.click('.tabs button:has-text("Bancadas")')
await p.waitForTimeout(400)
console.log('bancadas →', (await p.textContent('.tickets'))?.replace(/\s+/g,' ').slice(0, 220))
await p.screenshot({ path: '/tmp/bancadas.png' })
