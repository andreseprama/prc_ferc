...
const GAME = { id: 'g1', title: 'FC Porto x OGC Nice', opponent: 'OGC Nice', competition: 'Liga Europa', match_date: '2025-11-27', match_time: '17:45', created_at: '2026-07-01', kids: [{ id: 'k1', game_id: 'g1', name: 'Tomás', added_by: 'u-admin', adder: { name: 'André Couto' } }], tickets: TICKETS }
const ACTIVITY = [
